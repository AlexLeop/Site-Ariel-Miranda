          ...
          <div className="w-full md:w-5/12 reveal">
            <div className="relative group perspective-1000">
               ...
               <div className="relative z-10 overflow-hidden rounded-sm shadow-2xl">
                 ...
                 <img 
                   src="https://www.cache2net3.com//Repositorio/19349/Conteudos/133153/QUEM%20SOU.png" 
                   alt="Perito Ariel Miranda" 
               ...
               <div className="absolute -bottom-8 -right-8 bg-white p-6 rounded shadow-xl z-30 border-l-4 border-gold-500 hidden lg:block">
                  <p className="font-heading font-bold text-navy-900 text-lg">Perito Especialista</p>
                  <p className="text-slate-500 text-xs uppercase tracking-wide mt-1">Atuação Nacional</p>
               </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-7/12">
            <div className="reveal reveal-delay-200">
              ...
              <h2 className="text-4xl md:text-5xl font-heading font-extrabold text-navy-900 mb-2 leading-tight">
                Perito Ariel Miranda
              </h2>
              <h3 className="text-xl md:text-2xl text-slate-400 font-light mb-8">
                Engenharia, Segurança & Forense Digital
              </h3>
              
              <div className="space-y-6 text-slate-700 text-base leading-relaxed text-justify font-light">
                <p>
                  No complexo cenário das perícias técnicas, o <strong className="text-navy-900 font-semibold">Perito Ariel Miranda</strong> se destaca pela precisão e imparcialidade de seus laudos, oferecendo suporte confiável para decisões judiciais e extrajudiciais.
                </p>
                <p>
                  Com atuação nacional e equipe multidisciplinar, somos referência em Engenharia Elétrica, Segurança do Trabalho, Forense Digital e Cálculos Trabalhistas, sempre guiados por ética, excelência e responsabilidade técnica. Cada parecer ou laudo técnico que emitimos é fruto de conhecimento, experiência e compromisso com a verdade científica.
                </p>
              </div>
